<template>
  <div class="switch p-2 m-1 my-3 bg-white shadow-sm rounded-3">
    <div class="row">
      <div
        class="icon col-3 col-sm-2 rounded-circle d-flex align-items-center justify-content-center"
      >
      ...
      <div
        class="options col-12 col-sm-5 mx-auto my-1 my-sm-0 d-flex flex-column"
      >
        <ele-action-btn
